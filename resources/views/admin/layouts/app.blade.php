...
<head>
    ...
    <link href="{{ asset('public/backend/assets/plugins/ckeditor/plugins/codesnippet/lib/highlight/styles/dark.css') }}" rel="stylesheet" />
    <!-- loader-->
...
<body>
    ...
    <script src="{{ asset('public/backend/assets/plugins/ckeditor/plugins/codesnippet/lib/highlight/highlight.pack.js') }}"></script>
