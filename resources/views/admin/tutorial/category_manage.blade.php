                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="p-4 border rounded">
                                                                  <form action="{{ route('update.category',$category->id) }}" method="post" class="row g-3 needs-validation" novalidate>
                                                                   @csrf
                                                                   <div class="col-md-12">
                   ...
                   <div class="modal-body">
                       <div class="row">
                           <div class="col-xl-8 mx-auto"> 
                               ...
                               <hr/>
                               <div class="p-4 border rounded">
                                   <form action="{{ route('create.category') }}" method="post" class="row g-3 needs-validation" novalidate>
                                       @csrf
                                       <div class="col-md-12">
